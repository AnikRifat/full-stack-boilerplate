...
One Laravel application owns the database. Livewire and API controllers use the same user and role models. Do not make another Laravel application or let Next.js query the database directly.
